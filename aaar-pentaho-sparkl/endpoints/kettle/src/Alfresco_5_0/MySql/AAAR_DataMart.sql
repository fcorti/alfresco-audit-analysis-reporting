...
CREATE TABLE `dm_dim_alfresco` (
  ...
  `url_service_suffix` varchar(128) NOT NULL,
...
INSERT INTO `dm_dim_alfresco` (`id`, `desc`, `login`, `password`, `url`, `url_service_suffix`, `url_audit_suffix`, `url_cmis_suffix`, `url_workflow_definitions_suffix`, `url_workflow_instances_suffix`, `is_active`) VALUES (1,'Default Alfresco instance','admin','admin','http://localhost:8080','/alfresco/service','/alfresco/service/api/audit/query/alfresco-access?verbose=true&limit=50000','/alfresco/api/-default-/cmis/versions/1.1/atom','/alfresco/service/api/workflow-definitions','/alfresco/service/api/workflow-instances','Y');
...
--
-- ORDER BY:  `alfresco_id`,`cmis_objectid`,`cmis_parentid`
...
--
-- ORDER BY:  `alfresco_id`,`cmis_objectid`
...
/*!50001 CREATE TABLE `vw_dm_fact_repository` (
  ...
  `creation_date_id` tinyint NOT NULL,
  `creation_minute_id` tinyint NOT NULL,
  `user_last_modification_id` tinyint NOT NULL,
  `last_modification_date_id` tinyint NOT NULL,
  `last_modification_minute_id` tinyint NOT NULL,
  `parent_id` tinyint NOT NULL,
