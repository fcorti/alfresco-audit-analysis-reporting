...
INSERT INTO dm_dim_alfresco (id, "desc", login, password, url, url_audit_suffix, url_cmis_suffix, is_active) VALUES (1, 'Default Alfresco instance', 'admin', 'admin', 'http://localhost:8080', '/alfresco/service/api/audit/query/alfresco-access?verbose=true&limit=50000', '/alfresco/api/-default-/cmis/versions/1.1/atom', 'Y');
