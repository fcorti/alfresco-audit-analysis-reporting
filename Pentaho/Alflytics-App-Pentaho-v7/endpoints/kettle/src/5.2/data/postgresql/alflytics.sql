...
CREATE TABLE "DWH_ALF_DIM_INSTANCES"("ID" SMALLINT NOT NULL PRIMARY KEY,"DESCRIPTION" VARCHAR(32768) NOT NULL,"LOGIN" VARCHAR(32768) NOT NULL,"PASSWORD" VARCHAR(32768) NOT NULL,"PROTOCOL" VARCHAR(32768) NOT NULL,"HOST" VARCHAR(32768) NOT NULL,"PORT" VARCHAR(32768) NOT NULL,"USER_LIMIT" INTEGER NOT NULL,"AUDIT_LIMIT" INTEGER NOT NULL,"NODE_LIMIT" INTEGER NOT NULL,"WORKFLOW_LIMIT" INTEGER NOT NULL,"IS_ACTIVE" CHARACTER(1) DEFAULT 'Y' NOT NULL);

CREATE TABLE "DWH_DATA_QUALITY"("SOURCE_TYPE" VARCHAR(32768) NOT NULL,"SOURCE_ID" SMALLINT NOT NULL,"BATCH_ID" VARCHAR(32768) NOT NULL,"ENTITIES" VARCHAR(32768) NOT NULL,"LAYER" VARCHAR(32768) NOT NULL,"VALUE" INTEGER NOT NULL,"CREATION" TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL);

CREATE TABLE "DWH_DATA_QUALITY_LOGS"("SOURCE_TYPE" VARCHAR(32768) NOT NULL,"SOURCE_ID" SMALLINT NOT NULL,"BATCH_ID" VARCHAR(32768) NOT NULL,"DESCRIPTION" VARCHAR(32768) NOT NULL,"BATCH_START" TIMESTAMP NOT NULL,"BATCH_END" TIMESTAMP NOT NULL,"SUCCESS" CHARACTER(1) NOT NULL);

CREATE TABLE "DWH_ALF_CLASSES"("ID" SMALLINT NOT NULL PRIMARY KEY,"NAME" VARCHAR(32768) NOT NULL,"IS_FILE" CHARACTER(1) NOT NULL,"IS_FOLDER" CHARACTER(1) NOT NULL,"IS_ASPECT" CHARACTER(1) NOT NULL,"IS_ROOT" CHARACTER(1) NOT NULL,"OPE_TABLE_NAME" VARCHAR(32768) NOT NULL,"DWH_TABLE_NAME" VARCHAR(32768),"ORDINAL" SMALLINT NOT NULL,"INSTANCE_ID" SMALLINT NOT NULL,"IS_ACTIVE" CHARACTER(1) DEFAULT 'Y' NOT NULL,CONSTRAINT "FK_DWH_ALF_CLASSES_DWH_ALF_DIM_INSTANCES" FOREIGN KEY("INSTANCE_ID") REFERENCES "DWH_ALF_DIM_INSTANCES"("ID") ON DELETE CASCADE ON UPDATE CASCADE);

CREATE UNIQUE INDEX "UNQ_DWH_ALF_CLASSES" ON "DWH_ALF_CLASSES"("INSTANCE_ID","NAME");

CREATE TABLE "STG_ALF_NODES"("INSTANCE_ID" SMALLINT NOT NULL,"ID" VARCHAR(32768) NOT NULL,"IS_MODIFIED" CHARACTER(1) NOT NULL,"ENTRY" VARCHAR(32768) NOT NULL,"FILE_NAME" VARCHAR(32768) NOT NULL,CONSTRAINT "PK_STG_ALF_NODES" PRIMARY KEY("INSTANCE_ID","ID"),CONSTRAINT "FK_STG_ALF_NODES_DWH_ALF_DIM_INSTANCES" FOREIGN KEY("INSTANCE_ID") REFERENCES "DWH_ALF_DIM_INSTANCES"("ID") ON DELETE CASCADE ON UPDATE CASCADE);

CREATE TABLE "STG_ALF_CATEGORIES"("INSTANCE_ID" SMALLINT NOT NULL,"ID" VARCHAR(32768) NOT NULL,"IS_MODIFIED" CHARACTER(1) NOT NULL,"ENTRY" VARCHAR(32768) NOT NULL,"FILE_NAME" VARCHAR(32768) NOT NULL,CONSTRAINT "PK_STG_ALF_CATEGORIES" PRIMARY KEY("INSTANCE_ID","ID"),CONSTRAINT "FK_STG_ALF_CATEGORIES_DWH_ALF_DIM_INSTANCES" FOREIGN KEY("INSTANCE_ID") REFERENCES "DWH_ALF_DIM_INSTANCES"("ID") ON DELETE CASCADE ON UPDATE CASCADE);

CREATE TABLE "DWH_ALF_CLASS_PROPERTIES"("ID" SMALLINT NOT NULL PRIMARY KEY,"NAME" VARCHAR(32768) NOT NULL,"TYPE" VARCHAR(32768) NOT NULL,"IS_MULTIVALUE" CHARACTER(1) DEFAULT 'N' NOT NULL,"OPE_TABLE_NAME" VARCHAR(32768),"IS_OPE_INDEXED" CHARACTER(1),"DWH_TABLE_NAME" VARCHAR(32768),"IS_DWH_INDEXED" CHARACTER(1),"JSON_PATH" VARCHAR(32768) NOT NULL,"FIELD_NAME" VARCHAR(32768) NOT NULL,"CLASS_ID" SMALLINT NOT NULL,"IS_ACTIVE" CHARACTER(1) DEFAULT 'Y' NOT NULL,CONSTRAINT "FK_DWH_ALF_CLASS_PROPERTIES_DWH_ALF_CLASSES" FOREIGN KEY("CLASS_ID") REFERENCES "DWH_ALF_CLASSES"("ID") ON DELETE CASCADE ON UPDATE CASCADE);
...
CREATE TABLE "STG_ALF_USERS"("INSTANCE_ID" SMALLINT NOT NULL,"ID" VARCHAR(32768) NOT NULL,"IS_MODIFIED" CHARACTER(1) NOT NULL,"ENTRY" VARCHAR(32768) NOT NULL,"FILE_NAME" VARCHAR(32768) NOT NULL,CONSTRAINT "PK_STG_ALF_USERS" PRIMARY KEY("INSTANCE_ID","ID"),CONSTRAINT "FK_STG_ALF_USERS_DWH_ALF_DIM_INSTANCES" FOREIGN KEY("INSTANCE_ID") REFERENCES "DWH_ALF_DIM_INSTANCES"("ID") ON DELETE CASCADE ON UPDATE CASCADE);

CREATE TABLE "OPE_ALF_USERS"("INSTANCE_ID" SMALLINT NOT NULL,"ID" VARCHAR(32768) NOT NULL,"EMAIL" VARCHAR(32768),"FIRST_NAME" VARCHAR(32768) NOT NULL,"LAST_NAME" VARCHAR(32768),"ORGANIZATION" VARCHAR(32768),"IS_EMAIL_NOTIFICATIONS_ENABLED" BOOLEAN,"IS_ENABLED" BOOLEAN,CONSTRAINT "PK_OPE_ALF_USERS" PRIMARY KEY("INSTANCE_ID","ID"),CONSTRAINT "FK_OPE_ALF_USERS_DWH_ALF_DIM_INSTANCES" FOREIGN KEY("INSTANCE_ID") REFERENCES "DWH_ALF_DIM_INSTANCES"("ID") ON DELETE CASCADE ON UPDATE CASCADE);

CREATE TABLE "DWH_ALF_DIM_USERS"("ID" SERIAL PRIMARY KEY,"ALF_ID" VARCHAR(32768) NOT NULL,"EMAIL" VARCHAR(32768) NOT NULL,"FIRST_NAME" VARCHAR(32768) NOT NULL,"LAST_NAME" VARCHAR(32768) NOT NULL,"ORGANIZATION" VARCHAR(32768) NOT NULL,"IS_EMAIL_NOTIFICATIONS_ENABLED" BOOLEAN NOT NULL,"IS_ENABLED" BOOLEAN NOT NULL,"DT_DELETED" DATE,"INSTANCE_ID" SMALLINT NOT NULL,"SRC_ID" VARCHAR(32768) NOT NULL,CONSTRAINT "FK_DWH_ALF_DIM_USERS_DWH_ALF_DIM_INSTANCES" FOREIGN KEY("INSTANCE_ID") REFERENCES "DWH_ALF_DIM_INSTANCES"("ID") ON DELETE CASCADE ON UPDATE CASCADE);

ALTER SEQUENCE "DWH_ALF_DIM_USERS_ID_seq" RESTART WITH 1 INCREMENT BY 1;

CREATE INDEX "IDX_DWH_ALF_DIM_USERS_SRC_ID" ON "DWH_ALF_DIM_USERS"("INSTANCE_ID","SRC_ID");

CREATE UNIQUE INDEX "UNQ_DWH_ALF_DIM_USERS" ON "DWH_ALF_DIM_USERS"("ALF_ID","INSTANCE_ID");

CREATE TABLE "OPE_ALF_CATEGORIES"("INSTANCE_ID" SMALLINT NOT NULL,"NODE_UUID" VARCHAR(32768) NOT NULL,"NODE_TYPE" VARCHAR(32768) NOT NULL,"NAME" VARCHAR(32768) NOT NULL,"CREATED_AT" TIMESTAMP NOT NULL,"CREATED_BY" VARCHAR(32768) NOT NULL,"MODIFIED_AT" TIMESTAMP NOT NULL,"MODIFIED_BY" VARCHAR(32768) NOT NULL,"PARENT_NODE_UUID" VARCHAR(32768) NOT NULL,CONSTRAINT "PK_OPE_ALF_CATEGORIES" PRIMARY KEY("INSTANCE_ID","NODE_UUID"));

CREATE TABLE "DWH_DIM_DATES_YEARS"("ID" SMALLINT PRIMARY KEY,"DESCRIPTION" VARCHAR(32768) NOT NULL);

CREATE TABLE "DWH_DIM_DATES_MONTHS"("ID" DATE PRIMARY KEY,"DESCRIPTION" VARCHAR(32768) NOT NULL,"MONTH_DESCRIPTION" VARCHAR(32768) NOT NULL,"YEAR_ID" SMALLINT NOT NULL,FOREIGN KEY("YEAR_ID") REFERENCES "DWH_DIM_DATES_YEARS"("ID"));

CREATE TABLE "DWH_DIM_DATES"("ID" DATE PRIMARY KEY,"DESCRIPTION" VARCHAR(32768) NOT NULL,"DATE_DESCRIPTION" VARCHAR(32768) NOT NULL,"MONTH_ID" DATE NOT NULL,FOREIGN KEY("MONTH_ID") REFERENCES "DWH_DIM_DATES_MONTHS"("ID"));

CREATE TABLE "DWH_ALF_DIM_CATEGORIES"("ID" SERIAL PRIMARY KEY,"NAME" VARCHAR(32768) NOT NULL,"CREATED_AT" DATE NOT NULL,"CREATED_BY" INTEGER NOT NULL,"MODIFIED_AT" DATE NOT NULL,"MODIFIED_BY" INTEGER NOT NULL,"PARENT_ID" INTEGER NOT NULL,"INSTANCE_ID" SMALLINT NOT NULL,"SRC_ID" VARCHAR(32768) NOT NULL,FOREIGN KEY("CREATED_BY") REFERENCES "DWH_ALF_DIM_USERS"("ID") ON DELETE CASCADE ON UPDATE CASCADE,FOREIGN KEY("MODIFIED_BY") REFERENCES "DWH_ALF_DIM_USERS"("ID") ON DELETE CASCADE ON UPDATE CASCADE,FOREIGN KEY("CREATED_AT") REFERENCES "DWH_DIM_DATES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,FOREIGN KEY("MODIFIED_AT") REFERENCES "DWH_DIM_DATES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,FOREIGN KEY("PARENT_ID") REFERENCES "DWH_ALF_DIM_CATEGORIES"("ID") ON DELETE CASCADE ON UPDATE CASCADE);

ALTER SEQUENCE "DWH_ALF_DIM_CATEGORIES_ID_seq" RESTART WITH 1 INCREMENT BY 1;

CREATE INDEX "IDX_DWH_ALF_DIM_CATEGORIES_SRC_ID" ON "DWH_ALF_DIM_CATEGORIES"("INSTANCE_ID","SRC_ID");

CREATE TABLE "DWH_ALF_DIM_TAGS"("ID" SERIAL PRIMARY KEY,"NAME" VARCHAR(32768) NOT NULL,"CREATED_AT" DATE NOT NULL,"CREATED_BY" INTEGER NOT NULL,"MODIFIED_AT" DATE NOT NULL,"MODIFIED_BY" INTEGER NOT NULL,"INSTANCE_ID" SMALLINT NOT NULL,"SRC_ID" VARCHAR(32768) NOT NULL,FOREIGN KEY("CREATED_BY") REFERENCES "DWH_ALF_DIM_USERS"("ID") ON DELETE CASCADE ON UPDATE CASCADE,FOREIGN KEY("MODIFIED_BY") REFERENCES "DWH_ALF_DIM_USERS"("ID") ON DELETE CASCADE ON UPDATE CASCADE,FOREIGN KEY("CREATED_AT") REFERENCES "DWH_DIM_DATES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,FOREIGN KEY("MODIFIED_AT") REFERENCES "DWH_DIM_DATES"("ID") ON DELETE CASCADE ON UPDATE CASCADE);

ALTER SEQUENCE "DWH_ALF_DIM_TAGS_ID_seq" RESTART WITH 1 INCREMENT BY 1;

CREATE INDEX "IDX_DWH_ALF_DIM_TAGS_SRC_ID" ON "DWH_ALF_DIM_TAGS"("INSTANCE_ID","SRC_ID");

CREATE TABLE "DWH_ALF_DIM_NODE_TYPES"("ID" SERIAL PRIMARY KEY,"DESCRIPTION" VARCHAR(32768) NOT NULL,"INSTANCE_ID" SMALLINT NOT NULL,"SRC_ID" VARCHAR(32768) NOT NULL,CONSTRAINT "FK_DWH_ALF_DIM_NODE_TYPES_DWH_ALF_DIM_INSTANCES" FOREIGN KEY("INSTANCE_ID") REFERENCES "DWH_ALF_DIM_INSTANCES"("ID"));

ALTER SEQUENCE "DWH_ALF_DIM_NODE_TYPES_ID_seq" RESTART WITH 1 INCREMENT BY 1;

CREATE TABLE "DWH_ALF_DIM_MIME_TYPES"("ID" SERIAL PRIMARY KEY,"DESCRIPTION" VARCHAR(32768) NOT NULL,"INSTANCE_ID" SMALLINT NOT NULL,"SRC_ID" VARCHAR(32768) NOT NULL,CONSTRAINT "FK_DWH_ALF_DIM_MIME_TYPES_DWH_ALF_DIM_INSTANCES" FOREIGN KEY("INSTANCE_ID") REFERENCES "DWH_ALF_DIM_INSTANCES"("ID"));

ALTER SEQUENCE "DWH_ALF_DIM_MIME_TYPES_ID_seq" RESTART WITH 1 INCREMENT BY 1;

CREATE TABLE "DWH_DIM_TIME_HOURS"("ID" SMALLINT NOT NULL PRIMARY KEY,"DESCRIPTION" VARCHAR(32768) NOT NULL);

CREATE TABLE "DWH_DIM_TIME_MINUTES"("ID" SMALLINT NOT NULL PRIMARY KEY,"DESCRIPTION" VARCHAR(32768) NOT NULL,"HOUR_ID" SMALLINT NOT NULL,CONSTRAINT "FK_DWH_DIM_TIME_MINUTES_DWH_DIM_TIME_HOURS" FOREIGN KEY("HOUR_ID") REFERENCES "DWH_DIM_TIME_HOURS"("ID") ON DELETE CASCADE ON UPDATE CASCADE);

CREATE TABLE "DWH_ALF_DIM_CONTENTS"("ID" SERIAL PRIMARY KEY,"NAME" VARCHAR(32768) NOT NULL,"NODE_TYPE_ID" INTEGER NOT NULL,"MIME_TYPE_ID" SMALLINT NOT NULL,"CREATED_DT" DATE NOT NULL,"CREATED_AT" SMALLINT NOT NULL,"CREATED_BY_ID" INTEGER NOT NULL,"MODIFIED_DT" DATE NOT NULL,"MODIFIED_AT" SMALLINT NOT NULL,"MODIFIED_BY_ID" INTEGER NOT NULL,"OWNER_ID" INTEGER NOT NULL,"SIZE_IN_BYTES" INTEGER NOT NULL,"PARENT_ID" INTEGER NOT NULL,"INSTANCE_ID" SMALLINT NOT NULL,"SRC_ID" VARCHAR(32768) NOT NULL,CONSTRAINT "FK_DWH_ALF_DIM_CONTENTS_DWH_ALF_INSTANCES" FOREIGN KEY("INSTANCE_ID") REFERENCES "DWH_ALF_DIM_INSTANCES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_CONTENTS_DWH_ALF_DIM_NODE_TYPES" FOREIGN KEY("NODE_TYPE_ID") REFERENCES "DWH_ALF_DIM_NODE_TYPES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_CONTENTS_DWH_ALF_DIM_MIME_TYPES" FOREIGN KEY("MIME_TYPE_ID") REFERENCES "DWH_ALF_DIM_MIME_TYPES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_CONTENTS_DWH_ALF_DIM_DATES_CREATED" FOREIGN KEY("CREATED_DT") REFERENCES "DWH_DIM_DATES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_CONTENTS_DWH_ALF_DIM_DATES_MODIFIED" FOREIGN KEY("MODIFIED_DT") REFERENCES "DWH_DIM_DATES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_CONTENTS_DWH_ALF_DIM_MINUTES_CREATED" FOREIGN KEY("CREATED_AT") REFERENCES "DWH_DIM_TIME_MINUTES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_CONTENTS_DWH_ALF_DIM_MINUTES_MODIFIED" FOREIGN KEY("MODIFIED_AT") REFERENCES "DWH_DIM_TIME_MINUTES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_CONTENTS_DWH_ALF_DIM_USERS_CREATED" FOREIGN KEY("CREATED_BY_ID") REFERENCES "DWH_ALF_DIM_USERS"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_CONTENTS_DWH_ALF_DIM_USERS_MODIFIED" FOREIGN KEY("MODIFIED_BY_ID") REFERENCES "DWH_ALF_DIM_USERS"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_CONTENTS_DWH_ALF_DIM_USERS_OWNER" FOREIGN KEY("OWNER_ID") REFERENCES "DWH_ALF_DIM_USERS"("ID") ON DELETE CASCADE ON UPDATE CASCADE);

ALTER SEQUENCE "DWH_ALF_DIM_CONTENTS_ID_seq" RESTART WITH 1 INCREMENT BY 1;

CREATE TABLE "DWH_ALF_DIM_FOLDERS"("ID" SERIAL PRIMARY KEY,"NAME" VARCHAR(32768) NOT NULL,"NODE_TYPE_ID" INTEGER NOT NULL,"CREATED_DT" DATE NOT NULL,"CREATED_AT" SMALLINT NOT NULL,"CREATED_BY_ID" INTEGER NOT NULL,"MODIFIED_DT" DATE NOT NULL,"MODIFIED_AT" SMALLINT NOT NULL,"MODIFIED_BY_ID" INTEGER NOT NULL,"OWNER_ID" INTEGER NOT NULL,"PARENT_ID" INTEGER NOT NULL,"INSTANCE_ID" SMALLINT NOT NULL,"SRC_ID" VARCHAR(32768) NOT NULL,CONSTRAINT "FK_DWH_ALF_DIM_FOLDERS_DWH_ALF_INSTANCES" FOREIGN KEY("INSTANCE_ID") REFERENCES "DWH_ALF_DIM_INSTANCES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_FOLDERS_DWH_ALF_DIM_NODE_TYPES" FOREIGN KEY("NODE_TYPE_ID") REFERENCES "DWH_ALF_DIM_NODE_TYPES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_FOLDERS_DWH_ALF_DIM_DATES_CREATED" FOREIGN KEY("CREATED_DT") REFERENCES "DWH_DIM_DATES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_FOLDERS_DWH_ALF_DIM_DATES_MODIFIED" FOREIGN KEY("MODIFIED_DT") REFERENCES "DWH_DIM_DATES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_FOLDERS_DWH_ALF_DIM_MINUTES_CREATED" FOREIGN KEY("CREATED_AT") REFERENCES "DWH_DIM_TIME_MINUTES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_FOLDERS_DWH_ALF_DIM_MINUTES_MODIFIED" FOREIGN KEY("MODIFIED_AT") REFERENCES "DWH_DIM_TIME_MINUTES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_FOLDERS_DWH_ALF_DIM_USERS_CREATED" FOREIGN KEY("CREATED_BY_ID") REFERENCES "DWH_ALF_DIM_USERS"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_FOLDERS_DWH_ALF_DIM_USERS_MODIFIED" FOREIGN KEY("MODIFIED_BY_ID") REFERENCES "DWH_ALF_DIM_USERS"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_FOLDERS_DWH_ALF_DIM_USERS_OWNER" FOREIGN KEY("OWNER_ID") REFERENCES "DWH_ALF_DIM_USERS"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_FOLDERS_DWH_ALF_DIM_FOLDERS" FOREIGN KEY("PARENT_ID") REFERENCES "DWH_ALF_DIM_FOLDERS"("ID") ON DELETE CASCADE ON UPDATE CASCADE);
...
CREATE TABLE "STG_ALF_WF_DEPLOYMENTS"("INSTANCE_ID" SMALLINT NOT NULL,"ID" INTEGER NOT NULL,"IS_MODIFIED" CHARACTER(1) NOT NULL,"ENTRY" VARCHAR(32768) NOT NULL,"FILE_NAME" VARCHAR(32768) NOT NULL,CONSTRAINT "PK_STG_ALF_WF_DEPLOYMENTS" PRIMARY KEY("INSTANCE_ID","ID"),CONSTRAINT "FK_STG_ALF_WF_DEPLOYMENTS_DWH_ALF_DIM_INSTANCES" FOREIGN KEY("INSTANCE_ID") REFERENCES "DWH_ALF_DIM_INSTANCES"("ID") ON DELETE CASCADE ON UPDATE CASCADE);

CREATE TABLE "STG_ALF_WF_DEFINITIONS"("INSTANCE_ID" SMALLINT NOT NULL,"ID" VARCHAR(32768) NOT NULL,"IS_MODIFIED" CHARACTER(1) NOT NULL,"ENTRY" VARCHAR(32768) NOT NULL,"FILE_NAME" VARCHAR(32768) NOT NULL,CONSTRAINT "PK_STG_ALF_WF_DEFINITIONS" PRIMARY KEY("INSTANCE_ID","ID"),CONSTRAINT "FK_STG_ALF_WF_DEFINITIONS_DWH_ALF_DIM_INSTANCES" FOREIGN KEY("INSTANCE_ID") REFERENCES "DWH_ALF_DIM_INSTANCES"("ID") ON DELETE CASCADE ON UPDATE CASCADE);

CREATE TABLE "STG_ALF_WF_TASKS"("INSTANCE_ID" SMALLINT NOT NULL,"ID" INTEGER NOT NULL,"IS_MODIFIED" CHARACTER(1) NOT NULL,"ENTRY" VARCHAR(32768) NOT NULL,"FILE_NAME" VARCHAR(32768) NOT NULL,CONSTRAINT "PK_STG_ALF_WF_TASKS" PRIMARY KEY("INSTANCE_ID","ID"),CONSTRAINT "FK_STG_ALF_WF_TASKS_DWH_ALF_DIM_INSTANCES" FOREIGN KEY("INSTANCE_ID") REFERENCES "DWH_ALF_DIM_INSTANCES"("ID") ON DELETE CASCADE ON UPDATE CASCADE);

CREATE TABLE "STG_ALF_WF_ITEMS"("INSTANCE_ID" SMALLINT NOT NULL,"ID" VARCHAR(32768) NOT NULL,"IS_MODIFIED" CHARACTER(1) NOT NULL,"ENTRY" VARCHAR(32768) NOT NULL,"FILE_NAME" VARCHAR(32768) NOT NULL,CONSTRAINT "FK_STG_ALF_WF_ITEMS_DWH_ALF_DIM_INSTANCES" FOREIGN KEY("INSTANCE_ID") REFERENCES "DWH_ALF_DIM_INSTANCES"("ID") ON DELETE CASCADE ON UPDATE CASCADE);

CREATE TABLE "OPE_ALF_WF_DEPLOYMENTS"("INSTANCE_ID" SMALLINT NOT NULL,"ID" INTEGER NOT NULL,"NAME" VARCHAR(32768) NOT NULL,"DEPLOYED_AT" TIMESTAMP NOT NULL,CONSTRAINT "PK_OPE_ALF_WF_DEPLOYMENTS" PRIMARY KEY("INSTANCE_ID","ID"));

CREATE TABLE "OPE_ALF_WF_DEFINITIONS"("INSTANCE_ID" SMALLINT NOT NULL,"ID" VARCHAR(32768) NOT NULL,"DEPLOYMENT_ID" INTEGER NOT NULL,"NAME" VARCHAR(32768) NOT NULL,"DESCRIPTION" VARCHAR(32768) NOT NULL,"VERSION" INTEGER NOT NULL,"KEY" VARCHAR(32768) NOT NULL,CONSTRAINT "PK_OPE_ALF_WF_DEFINITIONS" PRIMARY KEY("INSTANCE_ID","ID"),CONSTRAINT "FK_OPE_ALF_WF_DEFINITIONS_OPE_ALF_WF_DEPLOYMENTS" FOREIGN KEY("INSTANCE_ID","DEPLOYMENT_ID") REFERENCES "OPE_ALF_WF_DEPLOYMENTS"("INSTANCE_ID","ID") ON DELETE CASCADE ON UPDATE CASCADE);

CREATE TABLE "STG_ALF_WF_INSTANCES"("INSTANCE_ID" SMALLINT NOT NULL,"ID" INTEGER NOT NULL,"IS_MODIFIED" CHARACTER(1) NOT NULL,"ENTRY" VARCHAR(32768) NOT NULL,"FILE_NAME" VARCHAR(32768) NOT NULL,CONSTRAINT "PK_STG_ALF_WF_INSTANCES" PRIMARY KEY("INSTANCE_ID","ID"),CONSTRAINT "FK_STG_ALF_WF_INSTANCES_DWH_ALF_DIM_INSTANCES" FOREIGN KEY("INSTANCE_ID") REFERENCES "DWH_ALF_DIM_INSTANCES"("ID") ON DELETE CASCADE ON UPDATE CASCADE);

CREATE TABLE "OPE_ALF_WF_INSTANCES"("INSTANCE_ID" SMALLINT NOT NULL,"ID" INTEGER NOT NULL,"DEFINITION_ID" VARCHAR(32768) NOT NULL,"COMPLETED" BOOLEAN NOT NULL,"STARTED_AT" TIMESTAMP NOT NULL,"ENDED_AT" TIMESTAMP,CONSTRAINT "PK_OPE_ALF_WF_INSTANCES" PRIMARY KEY("INSTANCE_ID","ID"),CONSTRAINT "FK_OPE_ALF_WF_INSTANCES_OPE_ALF_WF_DEFINITIONS" FOREIGN KEY("INSTANCE_ID","DEFINITION_ID") REFERENCES "OPE_ALF_WF_DEFINITIONS"("INSTANCE_ID","ID") ON DELETE CASCADE ON UPDATE CASCADE);

CREATE TABLE "OPE_ALF_WF_TASKS"("INSTANCE_ID" SMALLINT NOT NULL,"ID" INTEGER NOT NULL,"WF_INSTANCE_ID" INTEGER NOT NULL,"NAME" VARCHAR(32768) NOT NULL,"DESCRIPTION" VARCHAR(32768) NOT NULL,"STARTED_AT" TIMESTAMP NOT NULL,"DUE_AT" TIMESTAMP,"ASSIGNEE" VARCHAR(32768) NOT NULL,"STATE" VARCHAR(32768) NOT NULL,"PRIORITY" INTEGER NOT NULL,"TASK_DEFINITION_ID" VARCHAR(32768) NOT NULL,CONSTRAINT "PK_OPE_ALF_WF_TASKS" PRIMARY KEY("INSTANCE_ID","ID"),CONSTRAINT "FK_OPE_ALF_WF_TASKS_OPE_ALF_WF_INSTANCES" FOREIGN KEY("INSTANCE_ID","WF_INSTANCE_ID") REFERENCES "OPE_ALF_WF_INSTANCES"("INSTANCE_ID","ID") ON DELETE CASCADE ON UPDATE CASCADE);

CREATE TABLE "OPE_ALF_WF_ITEMS"("INSTANCE_ID" SMALLINT NOT NULL,"ID" VARCHAR(32768) NOT NULL,"WF_INSTANCE_ID" INTEGER NOT NULL,CONSTRAINT "PK_OPE_ALF_WF_ITEMS" PRIMARY KEY("INSTANCE_ID","ID","WF_INSTANCE_ID"),CONSTRAINT "FK_OPE_ALF_WF_ITEMS_OPE_ALF_WF_INSTANCES" FOREIGN KEY("INSTANCE_ID","WF_INSTANCE_ID") REFERENCES "OPE_ALF_WF_INSTANCES"("INSTANCE_ID","ID") ON DELETE CASCADE ON UPDATE CASCADE);

CREATE TABLE "DWH_ALF_DIM_WF_DEPLOYMENTS"("ID" SERIAL PRIMARY KEY,"NAME" VARCHAR(32768) NOT NULL,"DEPLOYED_DT" DATE NOT NULL,"INSTANCE_ID" SMALLINT NOT NULL,"SRC_ID" INTEGER NOT NULL,CONSTRAINT "FK_DWH_ALF_DIM_WF_DEPLOYMENTS_DWH_ALF_DIM_DEPLOYED_DT" FOREIGN KEY("DEPLOYED_DT") REFERENCES "DWH_DIM_DATES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_WF_DEPLOYMENTS_DWH_ALF_INSTANCES" FOREIGN KEY("INSTANCE_ID") REFERENCES "DWH_ALF_DIM_INSTANCES"("ID") ON DELETE CASCADE ON UPDATE CASCADE);

ALTER SEQUENCE "DWH_ALF_DIM_WF_DEPLOYMENTS_ID_seq" RESTART WITH 1 INCREMENT BY 1;

CREATE INDEX "IDX_DWH_ALF_DIM_WF_DEPLOYMENTS_SRC_ID" ON "DWH_ALF_DIM_WF_DEPLOYMENTS"("INSTANCE_ID","SRC_ID");

CREATE TABLE "DWH_ALF_DIM_WF_DEFINITIONS"("ID" SERIAL PRIMARY KEY,"NAME" VARCHAR(32768) NOT NULL,"DESCRIPTION" VARCHAR(32768) NOT NULL,"VERSION" INTEGER NOT NULL,"KEY" VARCHAR(32768) NOT NULL,"DEPLOYMENT_ID" INTEGER NOT NULL,"INSTANCE_ID" SMALLINT NOT NULL,"SRC_ID" VARCHAR(32768) NOT NULL,CONSTRAINT "FK_DWH_ALF_DIM_WF_DEFINITIONS_DWH_ALF_DIM_DEPLOYMENTS" FOREIGN KEY("DEPLOYMENT_ID") REFERENCES "DWH_ALF_DIM_WF_DEPLOYMENTS"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_WF_DEFINITIONS_DWH_ALF_INSTANCES" FOREIGN KEY("INSTANCE_ID") REFERENCES "DWH_ALF_DIM_INSTANCES"("ID") ON DELETE CASCADE ON UPDATE CASCADE);

ALTER SEQUENCE "DWH_ALF_DIM_WF_DEFINITIONS_ID_seq" RESTART WITH 1 INCREMENT BY 1;

CREATE INDEX "IDX_DWH_ALF_DIM_WF_DEFINITIONS_SRC_ID" ON "DWH_ALF_DIM_WF_DEFINITIONS"("INSTANCE_ID","SRC_ID");
...
CREATE TABLE "DWH_ALF_DIM_WF_TASKS"("ID" SERIAL PRIMARY KEY,"NAME" VARCHAR(32768) NOT NULL,"DESCRIPTION" VARCHAR(32768) NOT NULL,"STARTED_DT" DATE NOT NULL,"STARTED_AT" SMALLINT NOT NULL,"DUE_DT" DATE NOT NULL,"DUE_AT" SMALLINT NOT NULL,"ASSIGNEE" VARCHAR(32768) NOT NULL,"STATE" VARCHAR(32768) NOT NULL,"PRIORITY" INTEGER NOT NULL,"TASK_DEFINITION_ID" VARCHAR(32768) NOT NULL,"WF_INSTANCE_ID" INTEGER NOT NULL,"INSTANCE_ID" SMALLINT NOT NULL,"SRC_ID" INTEGER NOT NULL,CONSTRAINT "FK_DWH_ALF_DIM_WF_TASKS_DWH_ALF_DIM_DATES_STARTED_DT" FOREIGN KEY("STARTED_DT") REFERENCES "DWH_DIM_DATES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_WF_TASKS_DWH_ALF_INSTANCES" FOREIGN KEY("INSTANCE_ID") REFERENCES "DWH_ALF_DIM_INSTANCES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_WF_TASKS_DWH_ALF_DIM_WF_INSTANCES" FOREIGN KEY("WF_INSTANCE_ID") REFERENCES "DWH_ALF_DIM_WF_INSTANCES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_WF_TASKS_DWH_ALF_DIM_DATES_DUE_AT" FOREIGN KEY("DUE_DT") REFERENCES "DWH_DIM_DATES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_WF_TASKS_DWH_ALF_DIM_TIME_MINUTES_DUE_AT" FOREIGN KEY("DUE_AT") REFERENCES "DWH_DIM_TIME_MINUTES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_DIM_WF_TASKS_DWH_ALF_DIM_TIME_MINUTES_STARTED_AT" FOREIGN KEY("STARTED_AT") REFERENCES "DWH_DIM_TIME_MINUTES"("ID") ON DELETE CASCADE ON UPDATE CASCADE);

ALTER SEQUENCE "DWH_ALF_DIM_WF_TASKS_ID_seq" RESTART WITH 1 INCREMENT BY 1;

CREATE INDEX "IDX_DWH_ALF_DIM_WF_TASKS_SRC_ID" ON "DWH_ALF_DIM_WF_TASKS"("INSTANCE_ID","SRC_ID");

CREATE TABLE "STG_ALF_AUDITS"("INSTANCE_ID" SMALLINT NOT NULL,"ID" INTEGER NOT NULL,"APPLICATION" VARCHAR(32768) NOT NULL,"ENTRY" VARCHAR(32768) NOT NULL,"FILE_NAME" VARCHAR(32768) NOT NULL,CONSTRAINT "PK_STG_ALF_AUDITS" PRIMARY KEY("INSTANCE_ID","ID","APPLICATION"),CONSTRAINT "FK_STG_ALF_AUDITS_DWH_ALF_DIM_INSTANCES" FOREIGN KEY("INSTANCE_ID") REFERENCES "DWH_ALF_DIM_INSTANCES"("ID") ON DELETE CASCADE ON UPDATE CASCADE);

CREATE TABLE "DWH_ALF_AUDIT_APPS"("ID" SMALLINT NOT NULL PRIMARY KEY,"NAME" VARCHAR(32768) NOT NULL,"URL_SUFFIX" VARCHAR(32768) NOT NULL,"QUERY_MAX_ID" VARCHAR(32768) NOT NULL,"OPE_TABLE_NAME" VARCHAR(32768) NOT NULL,"ORDINAL" SMALLINT NOT NULL,"INSTANCE_ID" SMALLINT NOT NULL,"IS_ACTIVE" CHARACTER(1) DEFAULT 'Y' NOT NULL,CONSTRAINT "FK_DWH_ALF_AUDIT_APPS_DWH_ALF_DIM_INSTANCES" FOREIGN KEY("INSTANCE_ID") REFERENCES "DWH_ALF_DIM_INSTANCES"("ID") ON DELETE CASCADE ON UPDATE CASCADE);

CREATE TABLE "DWH_ALF_AUDIT_PROPERTIES"("ID" SMALLINT NOT NULL PRIMARY KEY,"NAME" VARCHAR(32768) NOT NULL,"TYPE" VARCHAR(32768) NOT NULL,"IS_OPE_INDEXED" CHARACTER(1),"JSON_PATH" VARCHAR(32768) NOT NULL,"FIELD_NAME" VARCHAR(32768) NOT NULL,"APP_ID" SMALLINT NOT NULL,"IS_ACTIVE" CHARACTER(1) DEFAULT 'Y' NOT NULL,CONSTRAINT "FK_DWH_ALF_AUDIT_PROPERTIES_DWH_ALF_AUDIT_APPS" FOREIGN KEY("APP_ID") REFERENCES "DWH_ALF_AUDIT_APPS"("ID") ON DELETE CASCADE ON UPDATE CASCADE);

CREATE TABLE "DWH_ALF_DIM_ACTIONS"("ID" SERIAL PRIMARY KEY,"DESCRIPTION" VARCHAR(32768) NOT NULL,"INSTANCE_ID" SMALLINT NOT NULL,"SRC_ID" VARCHAR(32768) NOT NULL,CONSTRAINT "FK_DWH_ALF_DIM_ACTIONS_DWH_ALF_DIM_INSTANCES" FOREIGN KEY("INSTANCE_ID") REFERENCES "DWH_ALF_DIM_INSTANCES"("ID"));

ALTER SEQUENCE "DWH_ALF_DIM_ACTIONS_ID_seq" RESTART WITH 1 INCREMENT BY 1;

CREATE INDEX "IDX_DWH_ALF_DIM_ACTIONS_SRC_ID" ON "DWH_ALF_DIM_ACTIONS"("INSTANCE_ID","SRC_ID");

CREATE TABLE "DWH_ALF_FACT_ACCESSES"("USER_ID" INTEGER NOT NULL,"DATE_ID" DATE NOT NULL,"MINUTE_ID" SMALLINT NOT NULL,"ACTION_ID" INTEGER NOT NULL,"USER_DESCRIPTION" VARCHAR(32768) NOT NULL,"NODE_PATH" VARCHAR(32768) NOT NULL,"INSTANCE_ID" SMALLINT NOT NULL,"APP_ID" SMALLINT NOT NULL,"SRC_ID" INTEGER NOT NULL,CONSTRAINT "PK_DWH_ALF_FACT_ACCESSES" PRIMARY KEY("INSTANCE_ID","APP_ID","SRC_ID"),CONSTRAINT "FK_DWH_ALF_FACT_ACCESSES_DWH_ALF_INSTANCES" FOREIGN KEY("INSTANCE_ID") REFERENCES "DWH_ALF_DIM_INSTANCES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_FACT_ACCESSES_DWH_ALF_DIM_USERS" FOREIGN KEY("USER_ID") REFERENCES "DWH_ALF_DIM_USERS"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_FACT_ACCESSES_DWH_DIM_DATES" FOREIGN KEY("DATE_ID") REFERENCES "DWH_DIM_DATES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_FACT_ACCESSES_DWH_DIM_MINUTES" FOREIGN KEY("MINUTE_ID") REFERENCES "DWH_DIM_TIME_MINUTES"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_FACT_ACCESSES_DWH_ALF_DIM_ACTIONS" FOREIGN KEY("ACTION_ID") REFERENCES "DWH_ALF_DIM_ACTIONS"("ID") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "FK_DWH_ALF_FACT_ACCESSES_DWH_ALF_AUDIT_APPS" FOREIGN KEY("APP_ID") REFERENCES "DWH_ALF_AUDIT_APPS"("ID") ON DELETE CASCADE ON UPDATE CASCADE);
...
INSERT INTO "DWH_ALF_DIM_INSTANCES" VALUES(1,'Alfresco','admin','admin','http','192.168.1.10','8080',5000,5000,5000,5000,'Y');
